...
namespace EventStore.ClientAPI {
	...
	public class ConnectionSettingsBuilder {
		...
		private bool _enableCompatibilityMode;
		...
		/// <summary>
		/// Specifies if the client should run in Version 5 compatibility mode.
		/// </summary>
		/// <returns>A <see cref="ConnectionSettingsBuilder"/> for further configuration.</returns>
		public ConnectionSettingsBuilder SetCompatibilityMode(bool value) {
			_enableCompatibilityMode = value;
			return this;
		}
